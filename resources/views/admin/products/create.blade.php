        ...
        <form action="{{ route('admin.products.store') }}" method="POST" class="space-y-4">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" step="0.01" id="price" name="price" value="{{ old('price') }}" class="input input-bordered w-full" required>
                    @error('price')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div>
                    ...
                    <input type="number" id="stock" name="stock" value="{{ old('stock') }}" class="input input-bordered w-full" required>
                    @error('stock')
                        <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                    @enderror
                </div>
